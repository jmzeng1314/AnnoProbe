...
getwd()
setwd('test/')
## download GSE92681 data
# https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE92681
eSet=getGEO('GSE92681', destdir=".", AnnotGPL = F, getGPL = F)[[1]]
...
# NKILA among these downregulated lncRNAs (Fig 1A, GSE92681).
